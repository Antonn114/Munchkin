...
U64 soutOne(U64 b), nortOne(U64 b), eastOne(U64 b), noEaOne(U64 b),
    soEaOne(U64 b), westOne(U64 b), soWeOne(U64 b), noWeOne(U64 b);

U64 noNoEa(U64 b), noEaEa(U64 b), soEaEa(U64 b), soSoEa(U64 b), noNoWe(U64 b),
    noWeWe(U64 b), soWeWe(U64 b), soSoWe(U64 b);
